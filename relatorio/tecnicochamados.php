...
// Page header
    ...
    // Title
            ...
            $this->Cell(185,15,utf8_decode('Quantidade de chamados por técnicos'),2,0,'C');
    // Line break
            $this->Ln(20);
        }
...
// Page footer
    ...
    // Page number
        ...
        function headerTable()
        {
            ...
            $this -> Cell(60,7,utf8_decode('Técnico'),1,0,'C');
...
// Instanciation of inherited class
    ...
    WHERE
    c.encaminhar = u.id_usuario
    AND c.area_responsavel = ar.id_area
    GROUP BY u.nome , ar.nome_area
    ...
    while ($dados=mysqli_fetch_array($executa)) {
        ...
        $pdf -> Cell(60,5, utf8_decode($dados['Tecnico']),1,0,'C');
